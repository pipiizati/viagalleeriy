          ...
          <section class="mt-[100px]">
               <div class="w-[364px] bg-white rounded-md shadow-xl mx-auto px-10 py-5">
                    <div class="flex flex-col">
                         ...
                         <span class="mt-2 text-3xl font-inter mx-auto">Register</span>
                         <!-- end -->
                         <!-- input login -->
                         <span class="text-sm mt-5 mb-1"></span>
                         <input type="text" id="username" name="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Username" required />
                         <span class="text-sm mt-4 mb-1"></span>
                         <input type="email" id="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Email" required />
                         <span class="text-sm mt-4 mb-1"></span>
                         <div>
                         ...
                         <!-- button -->
                         <button type="submit" class="mt-7 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register
                         </button>
